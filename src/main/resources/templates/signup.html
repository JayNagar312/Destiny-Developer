...
<html>
<head>
  <title>Destiny Developer - SignUp</title>
  <meta charset="utf-8" />
...
<form action="SignUp" method="get" class="signup">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Username </label>
    <input type="text" class="form-control" id="username" aria-describedby="emailHelp" placeholder="Enter Your Name Here" name="user" required>
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control" id="password" placeholder="Create your Password" name="pass" required>
  </div>
...
<div id="message"></div>
  ...
  <button type="submit" class="btn btn-info" disabled="disabled" id="submitButton">Sign Up</button>
</form>
</div>
